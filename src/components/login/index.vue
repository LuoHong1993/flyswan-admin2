  ...
  <div class="login-vue">
    <div class="login-container">
      <div class="login-content">
        <div class="login-title">管理系统3</div>
      ...
      <p>体验账号/密码：guest/123456</p>
      <p class="copyright"> Copyright © 2019 <a href="http://blog.ruke.site/" target="_blank">ruke.site</a> - <a href="https://www.heyui.top/"  target="_blank"> thanks heyui</a></p>
    </div>
  </div>
</template>
<script>
